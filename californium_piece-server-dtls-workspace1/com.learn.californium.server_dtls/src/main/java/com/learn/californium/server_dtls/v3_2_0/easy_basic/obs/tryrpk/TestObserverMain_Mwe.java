package com.learn.californium.server_dtls.v3_2_0.easy_basic.obs.tryrpk;
 ...
 *
 *
 * 注释掉了 AdvancedMultiPskStore pskStore = new AdvancedMultiPskStore();
 * 注释掉了 pskStore.setKey("Client_identity", "secretPSK".getBytes());
 * 注释掉了 builder.setAdvancedPskStore(pskStore); 
 * 
 * 
 */
