...
public class TestMain_Simple2_newca {
	...
	public String serverPemCertificate="ktserverone.key";
	...
	public String serverPemCertificate_dir				="/mycerts/new/my_own";
	...
	public String caCertificate							="ktserverone.crt";
	...
	public void my_configureToPrepare() {
		...
		//cipherSuite = CipherSuite.TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384;
