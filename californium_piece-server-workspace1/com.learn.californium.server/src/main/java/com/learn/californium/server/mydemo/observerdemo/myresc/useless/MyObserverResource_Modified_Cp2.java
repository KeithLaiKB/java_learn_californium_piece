 ...
 *
 */
public class MyObserverResource_Modified_Cp2  extends MyCoapResource {
		...
		public MyObserverResource_Modified_Cp2(String name) {
			super(name);
		...
		private class UpdateTask extends TimerTask {
			@Override
			public void run() {
				System.out.println("UpdateTask-------name:"+MyObserverResource_Modified_Cp2.this.getName());
				//
